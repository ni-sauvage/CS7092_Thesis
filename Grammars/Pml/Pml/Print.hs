...
instance Print Pml.Abs.AnyExpr where
  prt i = \case
    ...
    Pml.Abs.AnyExprbitexor anyexpr1 anyexpr2 -> prPrec i 3 (concatD [prt 3 anyexpr1, doc (showString "^"), prt 4 anyexpr2])
    ...
    Pml.Abs.AnyExprlthen anyexpr1 anyexpr2 -> prPrec i 5 (concatD [prt 5 anyexpr1, doc (showString "<"), prt 6 anyexpr2])
    Pml.Abs.AnyExprgrthen anyexpr1 anyexpr2 -> prPrec i 5 (concatD [prt 5 anyexpr1, doc (showString ">"), prt 6 anyexpr2])
    ...
    Pml.Abs.AnyExprName name1 anyexpr name2 -> prPrec i 9 (concatD [prt 0 name1, doc (showString "["), prt 0 anyexpr, doc (showString "]"), doc (showString "@"), prt 0 name2])
    Pml.Abs.AnyExprRun name runargs runprio -> prPrec i 9 (concatD [doc (showString "run"), prt 0 name, doc (showString "("), prt 0 runargs, doc (showString ")"), prt 0 runprio])
