...
instance Print Obs.Abs.Scalar where
  prt i = \case
    ...
    Obs.Abs.ObsScalarCons threadid varval scalar -> prPrec i 0 (concatD [doc (showString "@@@"), prt 0 threadid, doc (showString "SCALAR"), doc (showString "_"), prt 0 varval, prt 0 scalar])

instance Print Obs.Abs.End where
  prt i = \case
    Obs.Abs.ObsEndSeq threadid varname -> prPrec i 0 (concatD [doc (showString "@@@"), prt 0 threadid, doc (showString "END"), prt 0 varname])

instance Print Obs.Abs.Args where
  prt i = \case
    Obs.Abs.ArgsConsString obsstr args -> prPrec i 0 (concatD [prt 0 obsstr, prt 0 args])
...
instance Print Obs.Abs.Varval where
  prt i = \case
    ...
    Obs.Abs.VarValStr obsstr -> prPrec i 0 (concatD [prt 0 obsstr])
