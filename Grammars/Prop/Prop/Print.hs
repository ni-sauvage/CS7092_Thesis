...
instance Print Prop.Abs.Exp where
  prt i = \case
    Prop.Abs.Eimpl exp1 exp2 -> prPrec i 0 (concatD [prt 1 exp1, doc (showString "==>"), prt 2 exp2])
    ...
    Prop.Abs.Equant quant cidents exp -> prPrec i 15 (concatD [prt 0 quant, prt 0 cidents, doc (showString "|"), prt 0 exp])
